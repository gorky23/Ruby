...
class BikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bike" do
    assert_difference("Bike.count") do
      post bikes_url, params: { bike: { first_part: @bike.first_part, second_part: @bike.second_part, third_part: @bike.third_part } }
    end
  ...
  test "should update bike" do
    patch bike_url(@bike), params: { bike: { first_part: @bike.first_part, second_part: @bike.second_part, third_part: @bike.third_part } }
